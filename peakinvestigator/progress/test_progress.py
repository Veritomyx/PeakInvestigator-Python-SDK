...
class LoggerProgressTest(Progress):
    ...
    def close(self):
        self.logger.info('Finished uploading {} of {}'.format(self.count, self.unit))

class LoggerProgressFactoryTest(ProgressFactory):
    def __init__(self):
        pass

    def create(self, total, unit):
        return LoggerProgressTest(total, unit)
