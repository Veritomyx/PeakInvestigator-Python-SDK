...
from peakinvestigator.lib.uploader import Uploader
...
class PeakInvestigatorSaaS(object):
    ...
    def upload(self, upload_action, local_file, num_scan=0):
        """Upload file to a SFTP server"""
        upload_action.num = num_scan
        uploader = Uploader(upload_action.host, upload_action.token, "Progress_Factory2")
